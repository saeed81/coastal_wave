set terminal postscript eps color enhanced clip dashed dashlength 5.0 linewidth 3.0 butt palfuncparam 2000,0.003  'Courier-New,bold' 50 #lw 3
set output "nondiv_hydro.ps"
set size 2.0,2.0
...
#set xtics ("1.5" 0.000000, "12" 0.301030, "24" 0.602060,"48" 0.903090,"96" 1.204120,"192" 1.505150,"384" 1.806180,"768" 2.107210,"{/Symbol=80 \245}" 2.408240)

##the one we have worked so far
#plot "result_mode_2_3_hydro_nondiv.dat" u (log($1)):2 w l title 'hydronondiv',"result_mode_2_3_hydro_div.dat" u (log($1)):2 w l title 'hydrodiv',"result_mode_2_3_nonhydro_div.dat" u (log($1)):2 w l title 'nonhydrodiv'
###
#set logscale x
set border 3
set xtics nomirror
...
set xtics ("1.5" 0.17609126, "2" 0.301030, "3" 0.47712125,"4" 0.60205999,"5" 0.69897,"6" 0.77815125,"7" 0.84509804,"8" 0.90308999,"10" 1, "15" 1.1760913, "20" 1.30103,"30" 1.4771213  ) font "Times-Roman, bold 30" 
set ytics font "Times-Roman, bold 30"
##the one we have worked so far
#plot "result_mode_2_3_hydro_nondiv.dat" u 1:2 w l title 'hydronondiv',"result_mode_2_3_hydro_div.dat" u 1:2 w l title 'hydrodiv',"result_mode_2_3_nonhydro_div.dat" u 1:2 w l title 'nonhydrodiv'
###

##the one we have worked so far
#plot "result_mode_2_3_hydro_nondiv.dat" u (log10($1)):2 w l title 'hydronondiv',"result_mode_2_3_hydro_div.dat" u (log10($1)):2 w l title 'hydrodiv',"result_mode_2_3_nonhydro_div.dat" u (log10($1)):2 w l title 'nonhydrodiv'
###

#set style line 10 linecolor rgb "red" linewidth 3.000 pointtype 2  dashtype 7 solid pointsize default pointinterval 0.1

#set style line 30 lt 6 lw 3 linecolor rgb "dark-green"

plot "result_mode_2_3_hydro_nondiv.dat" u (log10($1)):2 w l lt 13 lc 7 lw 2 notitle,"result_mode_2_3_hydro_div.dat" u (log10($1)):2 w l lt 2 lc 7 lw 2 notitle ,"result_mode_2_3_nonhydro_div.dat" u (log10($1)):2 w l lt 1 lc 7 lw 2 notitle 
